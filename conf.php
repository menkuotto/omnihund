 ...
 */  
    //base--------------------
    public static $baseApp='Omni'; //*Omni ha a saját(Omni_S::Res()) függvényét akarjuk meghívni

    public static $baseLang='hu';
    public static $baseTmpl='omni'; // a tmpl/ elé teszi ésa a File::pathD()-ot használja,de megadhato MOtto vagy root előtaggal fix elérés is
